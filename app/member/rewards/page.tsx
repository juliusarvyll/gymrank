...
export default function MemberRewardsPage() {
  return (
    <Suspense fallback={<div className="rounded-[32px] border border-white/80 bg-white/85 p-6 text-sm text-slate-500 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">Loading reward catalog...</div>}>
...
async function MemberRewardsContent() {
  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      <section className="rounded-[32px] bg-[linear-gradient(135deg,#082f49_0%,#0f172a_46%,#10b981_155%)] p-6 text-white shadow-[0_28px_90px_rgba(2,6,23,0.22)] sm:p-8">
        ...
        <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300 sm:text-base">
              The more you show up, the more you can unlock. Redeem XP for rewards your gym has stocked.
            </p>
          </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
        <div className="space-y-4">
          {rewards?.map((reward) => {
            ...
            return (
              <Card key={reward.id} className="rounded-[32px] border-white/80 bg-white/92 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:p-6">
        ...
        <Card className="rounded-[32px] border-white/80 bg-white/92 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:p-6">
          ...
          <div className="mt-5 space-y-3">
            {redemptions?.map((redemption) => {
              ...
              return (
                <div key={redemption.id} className="rounded-[24px] bg-slate-50/90 p-4">
