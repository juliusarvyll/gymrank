...
export default function MemberCheckInQrPage() {
  return (
    <Suspense fallback={<div className="rounded-[32px] border border-white/80 bg-white/85 p-6 text-sm text-slate-500 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">Generating your QR pass...</div>}>
...
async function MemberCheckInQrContent() {
  ...
  const qrUrl = `${baseUrl}/member/check-in/qr/${token.token}`;
